...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private void filter(String newText) {
        ...
        for (Notes singlenNote : notes) {
            if (singlenNote.getTitle().toLowerCase().contains(newText.toLowerCase())
                    || singlenNote.getNotes().toLowerCase().contains(newText.toLowerCase())) {
                filteredList.add(singlenNote);
            }
        }
